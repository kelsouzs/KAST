...
def main():
    ...
    try:
        ...
        print("\n✅ Create and Training completed successfully!")
        ...
        log_content += f" Create and Training completed successfully in {str(duration).split('.')[0]}.\n"
        ...
        logger.info("Create and Training completed successfully")
        
    except Exception as e:
        error_msg = f"❌ CRITICAL ERROR during create and training: {str(e)}"
        print(f"\n{error_msg}")
